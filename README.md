...
A modern, high-performance C++23 backend for a photo gallery application, built with **H2O**, **Drogon**, **spdlog**, and **PostgreSQL**.
...
Ein modernes, hochperformantes C++23 Backend für eine Photo-Gallery Anwendung, entwickelt mit **H2O**, **Drogon**, **spdlog** und **PostgreSQL**.
